...
<pre class="">ss-local -c /etc/shadowsocks.json
</pre>
...
<pre class="">/etc/init.d/shadowsocks enable
</pre>
...
<pre class=""><code class="lang-shell avrasm">cd /tmp
</code># 下载
...
<pre class="">#shadowsocks自启动文件因为修改了，也会被删除
rm /etc/init.d/shadowsocks
...
<pre class="">#!/bin/sh /etc/rc.common
...
<pre class="">#   option resolvfile           '/tmp/resolv.conf.auto'
    option noresolv             1
...
<pre>iptables -t nat -A PREROUTING -s 路由器IP/24 -p udp --dport 53 -j DNAT --to 路由器IP
...
<pre>*/2 * * * * isfound=$(ps | grep "ss-redir" | grep -v "grep"); if [ -z "$isfound" ]; then echo "$(date): restart ss-redir..."&gt;&gt;/tmp/log/ss-monitor.log && /etc/init.d/shadowsocks restart; fi</pre>

 [1]: http://cache.maoshu.cc//wp-content/uploads/sinapicv2-backup/2630-ww3-mw600-005V4vEUjw1eoffaqtu7gj30c106baah.jpg
 [2]: http://cache.maoshu.cc//wp-content/uploads/sinapicv2-backup/2630-ww2-mw600-005V4vEUjw1eoffb3c9x1j30hr02c0tl.jpg
 [3]: http://cache.maoshu.cc//wp-content/uploads/sinapicv2-backup/2630-ww2-large-005V4vEUjw1eoffb9yvw5j30h408ogmi.jpg
 [4]: http://cache.maoshu.cc//wp-content/uploads/sinapicv2-backup/2630-ww4-large-005V4vEUjw1eoffbxzyhvj30ks04y0ul.jpg
 [5]: http://cache.maoshu.cc//wp-content/uploads/sinapicv2-backup/2630-ww4-large-005V4vEUjw1eoffc609q5j30aj0e8gni.jpg
 [6]: http://cache.maoshu.cc//wp-content/uploads/sinapicv2-backup/2630-ww1-large-005V4vEUjw1eoffcco2qaj30cb07wmxn.jpg
 [7]: http://cache.maoshu.cc//wp-content/uploads/sinapicv2-backup/2630-ww3-large-005V4vEUjw1eoffchajm7j30in09rmxk.jpg
 [8]: http://cache.maoshu.cc//wp-content/uploads/sinapicv2-backup/2630-ww3-large-005V4vEUjw1eoffcm15tcj30ez080q3k.jpg
