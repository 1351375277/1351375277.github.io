...
tags:
  ...
  - Kext
---
## [<img class="  wp-image-2582 aligncenter" src="http://cache.maoshu.cc//wp-content/uploads/2015/01/3523574.jpg" alt="3523574" width="395" height="298" />][1]

## <span style="color: #ff0000;">显卡支持列表</span>
...
<pre class="lang:default decode:true ">Device (GFX0)
{
Method ()
{
......
...
<span style="color: #ff0000;">在这里加入</span> Method (_DSM)
...
<span style="color: #ff0000;">当然，仍然可以用 i5-4200u的 0x06, 0x00,0x26, 0x0a</span>。
 ...
 [1]: http://cache.maoshu.cc//wp-content/uploads/2015/01/3523574.jpg
